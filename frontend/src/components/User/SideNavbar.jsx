...
const SideNavbar = ({
  ...
  return (
    <div
      ...
      } fixed md:relative left-0 top-0 h-full w-64 flex flex-col transition-transform duration-300 ease-in-out z-50 md:translate-x-0`}
    >
      <ul className="space-y-4 w-full bg-gradient-to-b from-blue-500 to-blue-700 text-white p-4 ">
        <li className="flex justify-center md:hidden rounded-3xl bg-background  text-white">
        ...
        <li className="flex flex-col items-center py-2 justify-center md:hidden rounded-3xl bg-background  text-white">
        ...
        <li>
          <a
            href="#"
            className="flex items-center p-2 hover:bg-blue-600 rounded w-full"
          >
        ...
        <li>
          <a
            ...
            className="flex items-center p-2 hover:bg-blue-600 rounded w-full"
          >
            <FaBook className="mr-2" /> Knowledge
          </a>
        </li>
        <li>
          <a
            ...
            className="flex items-center p-2 hover:bg-blue-600 rounded w-full"
          >
            <FaChild className="mr-2" /> Child Panel
          </a>
        </li>
        <li>
          <a
            ...
            className="flex items-center p-2 hover:bg-blue-600 rounded w-full"
          >
            <FaGift className="mr-2" /> Affiliate
          </a>
        </li>
        <li>
          <a
            ...
            className="flex items-center p-2 hover:bg-blue-600 rounded w-full"
          >
            <FaExclamationTriangle className="mr-2" /> API
          </a>
        </li>
        <li>
          <a
